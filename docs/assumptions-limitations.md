...
- Break-glass passwords generated by Terraform exist in state; BG1 was reset out-of-band and Terraform may retain an obsolete password until the separate lifecycle/state decision is applied. Both lab emergency accounts use portal-managed, tested synced passkeys. This satisfies mandatory portal MFA but retains a correlated passkey-provider/custody dependency; production should use independently stored physical FIDO2 keys or certificate-based authentication and never keep credentials in state.
